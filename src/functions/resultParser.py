...
def result(response, userLanguage, resultType, torrentType, page, category=None, week=None, query=None, originalQuery=None):
    ...
    if query:
        ...
        markup.add(telebot.types.InlineKeyboardButton(text='Nyaa', switch_inline_query_current_chat=f"!nyaa {query}"), telebot.types.InlineKeyboardButton(text='Your BitTorrent', switch_inline_query_current_chat=f"!ybt {query}"), telebot.types.InlineKeyboardButton(text='Tor Lock', switch_inline_query_current_chat=f"!tl {query}"))
